...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: t("stub.developers.title") };
}

/**
 * Stub page (ROADMAP.md S-03 / §1.1 rule 5): the real `/developers` page —
 * a proper API reference, not a widget on every screen — is a later unit.
 * This exists now so the footer link everywhere resolves instead of 404ing.
 */
